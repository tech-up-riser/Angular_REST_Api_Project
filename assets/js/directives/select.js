            ...
            return {
                ...
                link: function (scope, element, attrs, ngModel) {
                    ...
                    scope.$watch(function () {
                        ...
                        if (selectFx && _.isObject(newValue) && !_.isEqual(newValue, oldValue)) {
                            $timeout(function () {
                                selectFx.current = _.findIndex(selectFx.selOpts, function (opt) {
                                    return opt.getAttribute('data-value') == newValue.value;
                                });

                                selectFx._changeOption();
                            });
                        }
                    });
                }
